...
const PromptForm = ({ conversations, setConversations, activeConversation, generateResponse, isLoading, setIsLoading, onStop }) => {
  ...
  return (
    <form className="prompt-form" onSubmit={handleSubmit}>
      <input 
        placeholder={isLoading ? "Streaming response..." : "Message Gemini..."} 
      ...
      />
      {isLoading ? (
        <button type="button" className="stop-prompt-btn" onClick={onStop}>
